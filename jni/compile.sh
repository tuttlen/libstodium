...
#swig -java sodium.i
swig -java -package org.abstractj.kalium -outdir ../src/main/java/org/abstractj/kalium aesgcm.i
swig -csharp -package org.abstractj.kalium -outdir ../src/main/java/org/abstractj/kalium aesgcm.i
